...
![GitHub language count](https://img.shields.io/github/languages/count/European-XFEL/aravisCameras)
![GitHub top language](https://img.shields.io/github/languages/top/European-XFEL/aravisCameras)
![GitHub contributors](https://img.shields.io/github/contributors/European-XFEL/KararavisCamerasabo)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/European-XFEL/aravisCameras)
![GitHub Repo stars](https://img.shields.io/github/stars/European-XFEL/aravisCameras)
...
https://github.com/European-XFEL/aravisCameras
...
```
karabo-aravis-server [serverId=, ... karabo-cpp-server options]
```

You can directly start a device connected to a network camera using e.g.

```
karabo-aravis-server \
   serverId=MyServer 
